...
def train_yolo_model():
    ...
    # model_path = os.path.join(current_dir, "model", "yolo11n.pt")  # Use yolo11n.pt in the same directory
    ...
    # results = model.train(data=data_yaml_path, epochs=1, imgsz=400, device='mps', batch=32, half=True, int8=True, optimizer='Adam')
